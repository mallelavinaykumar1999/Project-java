...
class Medicine{
	DaoInterface1 Dao1=new DaoImpl1();
	...
	case 1:
    	...
    	Dao1.supplierRegistration(s);
		break;
	case 2:
		Dao1.viewAllSupplier();
		break;
	case 3:
		Dao1.searchBySupplierId();
		break;
	case 4:
		Dao1.deleteBySupplierId();
		break;
		default:
			System.out.println("invalid choice");
			break;
...
case 1:
	...
	Dao1.medicineRegistration(m1);
	break;
case 2:
	Dao1.viewAllMedicine();
	break;
case 3:
	Dao1.searchByMedicineId();
	break;
case 4:
	Dao1.deleteByMedicineId();
	break;
default:
	System.out.println("invalid choice");
	break;
